          ...
          <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <div class="m-5 w-50">
                    ...
                    <form action="{{url('update_minister_confirm', $minister->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                                            ...
                                            <div>
                                                ...
                                                <div class="mb-3">
                                                    <select class="form-select form-select-lg mb-3" name="district" id="state">
                                                        <option value="{{$minister->district}}">{{$minister->district}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="mb-3">
                                                    <select class="form-select form-select-lg mb-3" name="church" id="city" value="">
                                                        <option value="{{$minister->church}}">{{$minister->church}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div>
                                                    <input type="text" class="form-select form-select-lg  mb-3 " name="minister" style="text-transform:uppercase;" placeholder="Enter Minister Name" value="{{$minister->minister}}">
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <label for="image">CURRENT IMAGE</label>
                                                   <img style="margin: auto" height="100" width="100" src="/photos/{{$minister->image}}" alt="">
                                            </div> 
                                            ...
                                            <br>
                                            <div>
                                                <input type="submit"  class="btn btn-primary" value="Update Minister">
                                            </div>
