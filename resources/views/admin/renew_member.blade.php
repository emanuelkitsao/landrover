                    ...
                    <form action="getData" method="POST" enctype="multipart/form-data">
                        @csrf
                                            ...
                                            <div>
                                                ...
                                                <div>
                                                    <input type="text" class="form-select form-select-lg  mb-3" name="minister" placeholder="Enter Minister Name">
                                                </div>
                                            </div>
                         ...
                         <div class="center">
                        <button><a href="{{url('minister')}}"> go to dashboard</a> </button>
                    </div>
