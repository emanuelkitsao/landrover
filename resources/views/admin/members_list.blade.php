      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <table id="jaribu" class="table borderless center" style="width:100%">
            <thead>
              <tr>
                    <th>FULL NAMES</th>
                    <th>DISTRICT</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$minister->district_name}}</td>
                    <td>{{$minister->church_name}}</td>
                    <td>{{$minister->position}}</td>
                    <td>1234567890123</td>
                    <td><a class="btn btn-warning" href="{{url('update_minister', $minister->id)}}">EDIT</a> </td>
                  </tr>
                @endforeach
            </tbody>
            </table>
